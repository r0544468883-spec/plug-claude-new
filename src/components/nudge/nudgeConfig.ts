...
export const NUDGES: NudgeConfig[] = [
  {
    type: 'credits',
    titleHe: 'תוסיף לפלאג קצת קרדיטים?',
    titleEn: 'Top up PLUG with credits?',
    descHe: 'הקרדיטים שלך מניעים את ה-AI — ככל שיש יותר קרדיטים, יותר כלים פתוחים עבורך.',
    descEn: 'Your credits power the AI — more credits means more tools available to you.',
  ...
  },
  {
    ...
    descHe: 'משימות שגריר הן הדרך הכי מהירה לצבור קרדיטים קבועים ו-XP שמשדרג את הרמה שלך.',
    descEn: 'Ambassador missions are the fastest way to earn permanent credits and XP to level up.',
    featuresHe: ['קרדיטים קבועים שלא פגים', 'שדרוג רמת שגריר', 'גישה לכלים מתקדמים'],
    featuresEn: ['Permanent credits that never expire', 'Ambassador level upgrades', 'Access to advanced tools'],
