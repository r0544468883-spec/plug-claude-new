...
export default function CVAnalysis() {
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      <section className="bg-gradient-to-b from-green-500/10 to-transparent py-16 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold">ניתוח קורות חיים חינם עם AI</h1>
