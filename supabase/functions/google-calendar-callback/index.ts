...
const successClose = () =>
  new Response(
    `<!DOCTYPE html><html><head><meta charset="UTF-8"/></head><body><script>try{window.opener&&window.opener.postMessage({type:'PLUG_OAUTH_SUCCESS',provider:'calendar'},'*');}catch(e){}window.close();<\/script></body></html>`,
